...
$(function () {
    $.ajax({
        url: 'js/steepgraph/selenium-ide/iedoc-core.xml',
...
function addContextMenuButton(id, node, menu, isCase) {
    ...
    buttonWrapper.innerHTML = '<button class="btn-more"><img src="/steepgraph/images/SVG/more-icon.svg" alt="More" title="More"></button>';
...
function saveToFile() {
    ...
    var format = '.xml';
    var fileName = getTestCaseName() + format;
...
function getCommandsToGenerateScripts() {
    ...
    for (var index = 0; index < commands.length; index++) {
        ...
        let dataList = getCommandTargetDatalist(commands[index]);
        let sgsTarget = getCommandSGSTargetDatalist(commands[index]);        
        let command = new Command(commandName, commandTarget, commandValue);
        command.dataList = dataList;
        command.sgsTarget = sgsTarget;
        ret.push(command);
    }
    return ret;
}
...
function loadScripts() {
    ...
    switch (language) {
        case 'cs-wd-nunit':
            scriptNames = [
                'js/steepgraph/selenium-ide/formatCommandOnlyAdapter.js',
                'js/steepgraph/selenium-ide/remoteControl.js',
                "js/steepgraph/selenium-ide/format/csharp/cs-rc.js",
                'js/steepgraph/selenium-ide/webdriver.js',
                "js/steepgraph/selenium-ide/format/csharp/cs-wd.js"
            ];
            break;
        case 'cs-wd-mstest':
            scriptNames = [
                ...
                'js/steepgraph/selenium-ide/webdriver.js',
                "js/steepgraph/selenium-ide/format/csharp/cs-wd.js",
                "js/steepgraph/selenium-ide/format/csharp/cs-mstest-wd.js"
            ];
            break;
        case 'kat':
            scriptNames = [
                'js/steepgraph/selenium-ide/formatCommandOnlyAdapter.js',
                'js/steepgraph/selenium-ide/remoteControl.js',
                "js/steepgraph/selenium-ide/format/java/java-rc.js",
                "js/steepgraph/selenium-ide/format/java/java-rc-junit4.js",
                "js/steepgraph/selenium-ide/format/java/java-rc-testng.js",
                "js/steepgraph/selenium-ide/format/java/java-backed-junit4.js",
                "js/steepgraph/selenium-ide/format/steepgraph/kat.js"
            ];
            break;
        case 'java-wd-testng':
            scriptNames = [
                ...
                "js/steepgraph/selenium-ide/format/java/java-rc-testng.js",
                'js/steepgraph/selenium-ide/webdriver.js',
                "js/steepgraph/selenium-ide/format/java/webdriver-testng.js"
            ];
            break;
        case 'java-wd-junit':
            scriptNames = [
                ...
                "js/steepgraph/selenium-ide/format/java/java-rc-testng.js",
                'js/steepgraph/selenium-ide/webdriver.js',
                "js/steepgraph/selenium-ide/format/java/webdriver-junit4.js"
            ];
            break;
        case 'java-rc-junit':
            scriptNames = [
        ...
        case 'python-appdynamics':
            scriptNames = [
                'js/steepgraph/selenium-ide/formatCommandOnlyAdapter.js',
                'js/steepgraph/selenium-ide/remoteControl.js',
                "js/steepgraph/selenium-ide/format/python/python2-rc.js",
                'js/steepgraph/selenium-ide/webdriver.js',
                "js/steepgraph/selenium-ide/format/python/python-appdynamics.js"
            ];
            break;
        case 'python2-wd-unittest':
            scriptNames = [
                ...
                "js/steepgraph/selenium-ide/format/python/python2-rc.js",
                'js/steepgraph/selenium-ide/webdriver.js',
                "js/steepgraph/selenium-ide/format/python/python2-wd.js"
            ];
            break;
        case 'robot':
            scriptNames = [
                'js/steepgraph/selenium-ide/formatCommandOnlyAdapter.js',
                'js/steepgraph/selenium-ide/format/robot/robot.js'
            ];
            break;
        case 'ruby-wd-rspec':
            scriptNames = [
                'js/steepgraph/selenium-ide/formatCommandOnlyAdapter.js',
                'js/steepgraph/selenium-ide/remoteControl.js',
                "js/steepgraph/selenium-ide/format/ruby/ruby-rc.js",
                "js/steepgraph/selenium-ide/format/ruby/ruby-rc-rspec.js",
                'js/steepgraph/selenium-ide/webdriver.js',
                "js/steepgraph/selenium-ide/format/ruby/ruby-wd-rspec.js"
            ];
            break;
        case 'xml':
            scriptNames = [
                'js/steepgraph/selenium-ide/formatCommandOnlyAdapter.js',
                'js/steepgraph/selenium-ide/format/xml/XML-formatter.js'
            ];
            break;
        default:
...
function generateScripts(isExternalCapability, language, newFormatter) {
    ...
    if (isExternalCapability) {
        ...
        browser.runtime.sendMessage(
            extensionId,
            {
                type: 'steepgraph_recorder_export',
                payload: {
...
$(function () {
    $('#settings').on('click', function () {
        ...
        chrome.tabs.create({
            url: chrome.extension.getURL('steepgraph/options.html'),
...
$(function () {
    $('#record').attr('title', "Record");
    $('#playback').attr('title', "Play");
    $('#playSuite').attr('title', "Play Suite");
    $('#playSuites').attr('title', "Play All Suites");
...
$(function () {
    ...
    for (var buttonId in imagesLookup) {
        if (imagesLookup.hasOwnProperty(buttonId)) {
            var button = $(buttonId);
            var img = $('<img>');
            img.attr('src', '/steepgraph/images/SVG/' + imagesLookup[buttonId]);
...
function switchRecordButton(stop) {
    var record = $('#record');
    if (stop) {
        record.find('img').attr('src', '/steepgraph/images/SVG/record-icon-16.svg');
        record.removeClass("record--stop");
    } else {
        record.find('img').attr('src', '/steepgraph/images/SVG/stop-icon-16.svg');
...
$(function () {
    ...
    var kaEndpoint = 'https://www.steepgraph.com';
                ...
                $.ajax({
                    ...
                    success: function (response) {
                        ...
                        $.ajax({
                            ...
                            success: function () {
                                $.ajax({
                                    url: `${kaEndpoint}/api/v1/3DX-TAS-recorder/test-reports`,
                                    type: 'POST',
                                    data: {
                                        projectId: projectId,
    ...
    $('#ka-upload').on('click', function () {
        $.ajax({
            ...
            error: function (response) {
                ...
                showDialog('<p>Please log in , true');
            }
        });
    });
});
