...
class Recorder {
    ...
    //get parent frame names in sequence
    getFramePath(index) {
        ...
        while (currentWindow !== window.top) {
            if (window.frameElement) {
                if (currentWindow.frameElement.name)
                    framePath.unshift(currentWindow.frameElement.name);
                else
                    framePath.unshift(currentWindow.frameElement.id);
    ...
    getElementByXpath(element, path) {
